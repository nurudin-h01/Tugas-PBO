...
class Penjualan():
    ...
    def pesan(self, akun):
        ...
        if exist is None:
          ...
          for row in cursor:
              print('\n{:<15}{:<15}{:<15}{:<15}{:<15}{:<}'.format(row[1],row[2],row[3],row[4],row[9],row[5]))
    ...
    def keuntungan(self,akun):
        cursor = conn.execute("select * from penjualan inner join kumbung on penjualan.namakumbung = kumbung.namakumbung and penjualan.username = kumbung.username inner join jamur on penjualan.namajamur = jamur.namajamur and penjualan.username = jamur.username where penjualan.tanggal like ? and penjualan.username = ?",(self.tanggal,akun))
        print('\n{:<20}{:<20}{:<20}{:<20}{:<20}{:<20}{:<}'.format('tanggal','nama kumbung','nama jamur','jumlah','alamat','harga bibit','harga jual'))
        keuntungan = 0
        for row in cursor:
           print('\n{:<20}{:<20}{:<20}{:<20}{:<20}{:<20}{:<}'.format(row[1],row[2],row[3],row[4],row[8],row[12],row[13]))
           keuntungan = keuntungan + Penjualan.hasil(row[4],row[13],row[12])
        pengeluaran = 0
...
class Beranda():
    ...
    def menujamur(self, akun, user):
        ...
        if pilihan == 1:
            ...
            harga = int(input('Masukkan harga bibit = '))
            hargajual = int(input('Masukkan harga jual = '))
            if type(harga) == int and type(hargajual) == int:
                a = Jamur(nama,harga,hargajual)
                a.mengubah_data(akun)
            else :
                print("Data yang diinput tidak sesuai tipe datanya")
        elif pilihan == 4:
            nama = str(input('Masukkan nama jamur = '))
            a = Jamur(nama)
            a.menghapus_data(akun)
    ...
    def menupenjualan(self,akun,user):
        ...
        if pilihan == 1:
            ...
            if type(jumlah) == int:
                ...
                print("Data jumlah jamur yang diinput tidak sesuai tipe datanya")
        elif pilihan == 4:
            tanggal = str(input('Masukkan tanggal = '))
            nama = str(input('Masukkan nama Kumbung = '))
    ...
    def menupengeluaran(self,akun,user):
        ...
        if pilihan == 1:
            ...
            if type(biaya) == int:
                ...
                print("Data jumlah pengeluaran yang diinput tidak sesuai tipe datanya")
        elif pilihan == 4:
            tanggal = str(input('Masukkan tanggal = '))
            nama = str(input('Masukkan nama Kumbung = '))
